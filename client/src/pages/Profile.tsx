      ...
      await addRecipe({
        variables: {
          input: {
            ...
            ingredients: recipeDetails.ingredients.split(', ').map((ingredient: string) => ingredient),
            instructions: recipeDetails.instructions.split(', ').map((instruction: string) => instruction).filter(Boolean),
